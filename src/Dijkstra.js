function Dijkstra() {
	...
	var gridArray = [['P', 'W', 'P', 'P', 'P', 'P', 'P', 'P','P', 'W', 'P', 'P', 'P', 'W', 'P', 'P',], //0
		['P', 'W', 'W', 'W', 'W', 'W', 'W', 'W','P', 'W', 'P', 'P', 'P', 'W', 'P', 'P',], //1
		['P', 'W', 'P', 'P', 'P', 'P', 'P', 'P','P', 'W', 'P', 'P', 'P', 'W', 'P', 'P',], //2
		['P', 'W', 'P', 'W', 'W', 'W', 'W', 'W','W', 'W', 'P', 'P', 'P', 'W', 'P', 'P',], //3
		['P', 'W', 'P', 'P', 'P', 'P', 'P', 'P','P', 'W', 'P', 'P', 'P', 'P', 'P', 'P',], //4
		['P', 'W', 'W', 'W', 'W', 'W', 'W', 'W','P', 'W', 'P', 'P', 'P', 'W', 'P', 'P',],//5
		['P', 'W', 'P', 'P', 'P', 'P', 'P', 'P','P', 'W', 'P', 'P', 'P', 'W', 'P', 'P',],//6
		['P', 'W', 'P', 'W', 'W', 'W', 'W', 'W','W', 'W', 'W', 'W', 'W', 'P', 'P', 'P'],//7
		['P', 'W', 'P', 'P', 'P', 'P', 'P', 'P','P', 'P', 'P', 'P', 'W', 'P', 'P', 'P'],//8
		['P', 'W', 'W', 'W', 'W', 'W', 'P', 'W','W', 'W', 'P', 'P', 'W', 'P', 'P', 'P'],//9
		['P', 'W', 'P', 'P', 'P', 'W', 'P', 'P','P', 'P', 'P', 'P', 'W', 'P', 'P', 'P'],//10
		['P', 'W', 'P', 'P', 'W', 'W', 'W', 'P','P', 'P', 'P', 'P', 'W', 'P', 'P', 'P'],//11
		['P', 'P', 'P', 'P', 'P', 'W', 'P', 'P','P', 'P', 'W', 'P', 'P', 'P', 'P', 'P'],//12
		['P', 'W', 'P', 'P', 'P', 'W', 'P', 'P','P', 'P', 'W', 'P', 'P', 'P', 'P', 'P'],//13
		['P', 'W', 'P', 'P', 'P', 'W', 'P', 'P','P', 'P', 'W', 'P', 'P', 'P', 'P', 'P'],//14
		['P', 'W', 'P', 'P', 'P', 'P', 'P', 'P','P', 'P', 'P', 'P', 'W', 'P', 'P', 'P']]//15
